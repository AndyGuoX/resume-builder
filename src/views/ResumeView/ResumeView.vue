...
<template>
  <main class="min-h-screen">
    <aside
      v-show="!previewOnly"
      class="left-panel z-20 border-r border-gray-300 bg-white p-4 overflow-y-auto flex flex-col gap-4"
    >
      <ExportToolbar
        :loading="exporting"
    ...
    <section
      class="min-h-screen p-6 overflow-auto"
      :style="{ marginLeft: previewOnly ? '0' : 'var(--left-panel-width)' }"
    >
